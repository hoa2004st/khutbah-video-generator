...
import type {ExportResult, RenderJob, RenderMethod, RenderProgress} from '../src/global.js';
...
contextBridge.exposeInMainWorld('khutbahApi', {
  ...
  startRender: (deck: DeckSpec, outputPath: string, method: RenderMethod = 'remotion') =>
    ipcRenderer.invoke('render:start', deck, outputPath, method) as Promise<RenderJob>,
